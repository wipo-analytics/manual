...
However, different database providers may use their own definitions of patent families (which may or may not be explained). In 2020 patentscope introduct the concept of the Patent Cooperation Treaty family as described in Figure \@ref(fig:psfamily) below. 
...
For example, entering the search term "synthetic biology" and automated expansion produced the fillowing query in english, french and german for searches of abstracts. 
